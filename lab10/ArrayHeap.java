 ...
 */
public class ArrayHeap<T extends Comparable<T>>  implements ExtrinsicPQ<T> {
...
//        arr = (T[]) new Comparable[10];
    ...
    private void swim(int index) {
        ...
        /** TODO: Your code here. */
        while (inBounds(parentIndex(index)) && (contents[parentIndex(index)].compareTo(contents[index])) > 0) {
            int smaller = parentIndex(index);
    ...
    public void insert(T item, double priority) {
        ...
        /* TODO: Your code here! */
        int last = contents.length;
        this.setNode(last - 1, new Node(item, priority));
        swim(last - 1);
    }
    ...
    public void changePriority(T item, double priority) {
        ...
        for(int i = 1; i < contents.length; i++) {
            if (contents[i].item().equals(item)) {
                ...
                this.setNode(i, new Node(contents[i].item(), priority));
    ...
    private class Node {
        ...
        public int compareTo(Node content) {
            return 0;
        }
    }
